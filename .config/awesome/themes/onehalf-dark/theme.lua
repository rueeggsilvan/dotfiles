...
theme.cyan = "#98c379"
theme.white = "#dcdfe4"
theme.black_lite = "#DEDEDE"

-- Path of this theme config
theme.config_path = gfs.get_configuration_dir()

-- Set wallpaper
--theme.wallpapers_path = "/home/silvanr/pictures/wallpaper/*.jpg"
--theme.wallpaper = "/home/silvanr/pictures/wallpaper/01.jpg"
-- wallpaper_cmd = feh --big-scale /home/silvanr/pictures/wallpaper/01.jpg
...
theme.bg_systray = theme.darkgreen

theme.fg_normal = theme.black_lite
...
-- Menu settings
theme.menu_fg_normal = theme.black_lite
theme.menu_fg_focus = theme.black_lite

theme.menu_bg_normal = theme.darkgreen
...
theme.taglist_fg_occupied = theme.red
theme.taglist_fg_empty = theme.black_lite
theme.taglist_fg_volatile = theme.red

theme.taglist_bg_focus = theme.darkgreen
theme.taglist_bg_urgent = theme.darkgreen
theme.taglist_bg_occupied = theme.darkgreen
theme.taglist_bg_empty = theme.darkgreen
theme.taglist_bg_volatile = theme.darkgreen
...
theme.tasklist_bg_normal = theme.black_lite
theme.tasklist_bg_minimize = theme.darkgreen
...
theme.notification_bg = theme.darkgreen
theme.notification_bg_critical = theme.red
theme.notification_fg = theme.black_lite
...
theme.layout_bg = theme.darkgreen

-- Generate Awesome icon:
theme.awesome_icon = theme_assets.awesome_icon(20, theme.black_lite, theme.black)
